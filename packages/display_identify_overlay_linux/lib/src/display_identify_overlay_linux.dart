...
class DisplayIdentifyOverlayLinux implements pi.DisplayIdentifyOverlayPlatform {
  DisplayIdentifyOverlayLinux();
  static void registerWith() {
    if (!Platform.isLinux) return;
    pi.DisplayIdentifyOverlayPlatform.instance = DisplayIdentifyOverlayLinux();
  }
